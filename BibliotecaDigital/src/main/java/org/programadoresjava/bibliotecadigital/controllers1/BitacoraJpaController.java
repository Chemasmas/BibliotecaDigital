...
import org.programadoresjava.bibliotecadigital.models.Bitacora;
import org.programadoresjava.bibliotecadigital.models.BitacoraId;
...
public class BitacoraJpaController implements Serializable {
    ...
    public void create(Bitacora bitacora) throws PreexistingEntityException, RollbackFailureException, Exception {
    ...
    public void destroy(BitacoraId id) throws NonexistentEntityException, RollbackFailureException, Exception {
        EntityManager em = null;
        try {
            utx.begin();
            em = getEntityManager();
    ...
    public Bitacora findBitacora(BitacoraId id) {
        EntityManager em = getEntityManager();
        try {
